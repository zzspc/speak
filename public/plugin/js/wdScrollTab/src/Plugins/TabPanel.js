...
TabPanel.prototype = {
  ...
  addTab : function(tabitem){
    ...
    tabitem.id = tabitem.id || parseInt(Math.random()*100);
    ...
    else if(this.scrollFinish)
    {
	  ...
	  content.attr('id',tabitem.id+'_content');
  ...
  show : function(position, notExecuteMoveSee){
    ...
    if(this.scrollFinish)
    {
	  ...
	  //
	  this.tabs[position].title.removeClass('icon_title'); 
	  this.tabs[position].title.addClass('title');
	  this.tabs[position].title.css('background-image','');
  ...
  setIcon:function(position,url){
	position = this.getTabPosision(position);
    if(position < this.tabs.length)
	{
	  this.tabs[position].title.removeClass('title');	  
      this.tabs[position].title.addClass('icon_title');
	  this.tabs[position].title.css('background-image', 'url("'+url+'")');
	}  	
  },
